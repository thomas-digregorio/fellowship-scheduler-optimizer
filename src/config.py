...
def get_default_config() -> ScheduleConfig:
    ...
    return ScheduleConfig(
        ...
        call_soft_forbidden_next_week_blocks=["Research"],
        call_soft_forbidden_next_week_weight=-6,
        call_soft_disfavored_current_blocks=["Research"],
        call_soft_disfavored_current_weight=-3,
        ...
        srcva_weekend_exclude_adjacent_24hr_weeks=True,
        srcva_weekend_hard_forbidden_next_week_blocks=[
            "Night Float",
            "CCU",
            "Goodyer Consults",
            "PTO",
        ...
        srcva_weekend_soft_forbidden_next_week_blocks=["Research"],
        srcva_weekend_soft_forbidden_next_week_weight=-5,
        srcva_weekend_consecutive_same_fellow_weight=-4,
        ...
        srcva_combined_call_window_weeks=4,
        srcva_combined_call_window_max=2,
        hours_cap=80.0,
        trailing_avg_weeks=4,
        solver_timeout_seconds=600.0,
